...
<body>
<header>柴豆豆预约系统</header>
{{--<p style="padding: 20px 20px 0 20px;color: #ffb866;">2020 年 8 月 30 日为柴豆豆特别企划的“小嘤&卡卡一周岁”生日派对，全天共有五场每场80分钟内容丰富，如需购票请后退至上一级页面点击“8.30预约”即可，全体柴柴期待您的光临。</p>--}}
<div class="form">
    {{--    <div align="center">--}}
    {{--        <img src="{{ URL::asset('home/images/logo.png') }}" width="20%"/>--}}
    {{--    </div>--}}
    <div class="row">
...
{{--        <p class="tit" id="tit1" style="display: none; margin-left: 30%;font-size: 12px;">抱歉当前时段已经约满！</p>--}}
...
{{--            1.服务收费：每人入场费 88 元，限时 50 分钟。预约时每人需线上支付 5 元，剩余金额到店支付;<br/>--}}
{{--            2.场次标注时段为该场次开始和结束时间(如：13:05~13:55 场次，您应于 13:05 前到场，13:55 是该场次离场时间)，建议您提前候场，如即将迟到请尽早致电客服沟通保留，如开场 5 分钟仍无法通过电话与您取得联系，预约座位将不予保留;<br/>--}}
{{--            3. 手机号是核定身份的唯一凭证请准确填写；<br/>--}}
{{--            4. 请妥善选择“预约时段”，修改时段请至少在开场前一天致电客服沟通，因临近场次座位极有可能已约满，故不能保证可修改至您要求的某一特定时段；<br/>--}}
{{--            5. 暂不对12岁及以下朋友开放，敬请谅解。<br/>--}}
{{--            6. 请勿携带自家宠物进入互动区，本店谢绝自带食物及饮品，不可私自进行投喂。</p>--}}
            @foreach ($tips as $v)
    ...
    {{--    <p style="margin-top:20px;text-align: center;color: #ffb866;">霸王餐项目请联系门店</p>--}}
    {{--    <p style="margin-top:20px;text-align: center;color: #ffb866;">客服电话：13366712965</p>--}}
    <p style="margin-top:20px;text-align: center;color: #ffb866;">如需团体订单、包场服务、品牌合作，请致电柴豆豆客服号码：13520893390</p>
</div>
</body>
</html>
