...
class WeChatPayService {
    ...
    public function templateMessage($name, $number, $validTime, $openId) {
        ...
        $app = Factory::officialAccount([
            'app_id'    => 'wx644c5c34353198dc',
            'secret'    => '416d625d6ce0a775cbf156244d91004f',
            'token'     => 'easywechat',
        ]);
        $result = $app->template_message->send([
            'touser' => $openId,//用户openid
            'template_id' => 'OEl7zY_A5uyYn4UrPdW3kXUGBYpAuFB4cWRahpj63bg',//发送的模板id
            'url' => '',//发送后用户点击跳转的链接
            'data' => [
                'first' => [
                ...
                'remark' => [
                    'value' => '备注：如有疑问请致电客服咨询：13520893390。柴豆豆期待您的光临~~'
                ]
            ],
        ]);
