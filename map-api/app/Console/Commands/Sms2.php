...
class Sms2 extends Command
{
    // 静态变量
    protected $signature = 'sms:sendSms2';
    protected $description = '短信预约发送2';
    ...
    public function smsHandle()
    {
        ...
        if (count($telephones) > 0) {
            foreach ($telephones as $v) {
                dispatch(new SendMessageAsyncJob($v->telephone, 'SMS_213286272'));
                app('log')->info($v->telephone);
            }
        }
        // dispatch(new SendMessageAsyncJob('13418515003', 'SMS_213286272'));
        // dispatch(new SendMessageAsyncJob('18611224596', 'SMS_213286272'));
    }
}
